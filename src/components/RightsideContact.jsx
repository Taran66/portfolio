  ...
  return (
    <div className='flex w-6/12'>
        <form className='flex flex-col justify-between  w-full'>
            ...
            <textarea className='h-44 rounded-lg outline-none text-2xl p-3' placeholder='Your Message'/>
            <button type='submit' className='text-3xl bg-amber-400 rounded-md p-3 text-black hover:bg-amber-500 duration-500 ease-in-out'>Submit</button>
        </form>
    </div>
  )
}
